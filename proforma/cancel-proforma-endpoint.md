...
## Descripción
Anula una proforma y cambia su estado a `anulada`.
...
`PATCH /proformas/66ff3afe-65bb-49f2-80cf-ae279b7fcf5b/cancel`
...
Retorna la estructura completa de proforma, con `prfmaestado: "anulada"`.
...
- `409 Conflict`: `Only emitted proformas can be canceled`.
