...
## Descripción
Marca una proforma como pagada y descuenta stock de los ítems inventariables.
...
`PATCH /proformas/66ff3afe-65bb-49f2-80cf-ae279b7fcf5b/pay`
...
Retorna la estructura completa de proforma, con `prfmaestado: "pagada"`.
...
- `409 Conflict`:
  - `Only emitted proformas can be paid`
  - `Stock does not exist for branch and product`
  - `Stock is not active`
